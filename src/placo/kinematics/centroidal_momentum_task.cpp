...
CentroidalMomentumTask::CentroidalMomentumTask(Eigen::Vector3d L_world)
    : L_world(L_world) {}
...
void CentroidalMomentumTask::update() {
  ...
  if (solver->dt == 0) {
    throw std::runtime_error(
        "CentroidalMomentumTask: you should set solver.dt to use this task");
  }
...
std::string CentroidalMomentumTask::error_unit() { return "N.m rad/s"; }
} // namespace placo::kinematics