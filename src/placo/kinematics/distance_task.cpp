...
DistanceTask::DistanceTask(model::RobotWrapper::FrameIndex frame_a,
...
std::string DistanceTask::type_name() { return "distance"; }

std::string DistanceTask::error_unit() { return "m"; }
} // namespace placo::kinematics