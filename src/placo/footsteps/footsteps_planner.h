...
public:
   ...
   * @param footstep The footstep of one of the feet
   */
  Eigen::Affine3d opposite_frame(Footstep footstep);
  static Eigen::Affine3d opposite_frame(Footstep footstep, HumanoidParameters parameters_);

  /**
   * @brief Return the opposite footstep in a neutral position (i.e. at a
   * distance parameters.feet_spacing from the given footstep)
   */
  Footstep opposite_footstep(Footstep footstep);
