...
namespace placo {
FootstepsPlannerNaive::FootstepsPlannerNaive(Side initial_side,
...
FootstepsPlannerNaive::FootstepsPlannerNaive(std::string initial_side,
                                             Eigen::Affine3d T_world_left,
                                             Eigen::Affine3d T_world_right,
                                             double feet_spacing)
    : FootstepsPlanner(initial_side, T_world_left, T_world_right,
...
FootstepsPlannerNaive::plan(Eigen::Affine3d T_world_targetLeft,
