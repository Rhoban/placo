...
FootstepsPlannerRepetitive::FootstepsPlannerRepetitive(
    HumanoidParameters &parameters)
    : FootstepsPlanner(parameters) {}

std::string FootstepsPlannerRepetitive::name() { return "repetitive"; }

void FootstepsPlannerRepetitive::plan_impl(
...
void FootstepsPlannerRepetitive::configure(double x, double y, double theta,
                                           int steps) {
  d_x = x;
  d_y = y;
  d_theta = theta;
