...
public:
  ...
  /**
   * @brief Compute the next footsteps based on coordinates expressed in the
   * support frame laterally translated of +/- feet_spacing
...
protected:
   ...
   */
  void plan_impl(std::vector<Footstep> &footsteps,
