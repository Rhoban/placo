 ...
 *
 * A task is essentially a constraint of the form \f$ Ax = b \f$, where x is the
 * vector of joint delta positions solved by the kinematics solver.
 *
 * The task can be either an equality constraint (hard task) or an objective
 * (soft task).
 *
