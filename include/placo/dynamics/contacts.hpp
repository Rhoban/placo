...
public:
  ...
  /**
   * @brief true if the contact is active (ignored by the solver else, this
   * allow to enable/disable a contact without removing it from the solver)
   */
  bool active = true;
  ...
  /**
   * @brief Returns the size of the contact (number of forces added to the
   * problem)
   */
  int size();
  ...
  /**
   * @brief Expression of the forces applied on the contact, created by the \ref
   * DynamicsSolver::solve call
   */
...
public:
  /**
   * @brief see \ref DynamicsSolver::add_point_contact and \ref
  ...
  /**
   * @brief rotation matrix expressing the surface frame in the world frame (for
   * unilateral contact)
   */
...
public:
  /**
   * @brief see \ref DynamicsSolver::add_fixed_planar_contact and \ref
   * DynamicsSolver::add_unilateral_planar_contact
   */
