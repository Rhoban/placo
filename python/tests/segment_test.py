...
class TestProblem(unittest.TestCase):
    def test_parallelism(self):
        ...
        p4 = np.array([1, 1.01])
        p5 = np.array([1, 0.99])
        self.assertTrue(placo.Segment(p0, p1).is_parallel(placo.Segment(p2, p3), 1e-5))
        self.assertFalse(placo.Segment(p0, p1).is_parallel(placo.Segment(p0, p2), 1e-5))
        self.assertFalse(placo.Segment(p0, p2).is_parallel(placo.Segment(p0, p1), 1e-5))
        self.assertFalse(placo.Segment(p0, p2).is_parallel(placo.Segment(p0, p4), np.sin(np.pi/4)))
        self.assertTrue(placo.Segment(p0, p2).is_parallel(placo.Segment(p0, p5), np.sin(np.pi/4)))
    ...
    def test_point_aligned(self):
        ...
        p2 = np.array([2, 2])
        p3 = np.array([2, 1])
        self.assertTrue(placo.Segment(p0, p1).is_point_aligned(p0, 1e-5))
        self.assertTrue(placo.Segment(p0, p1).is_point_aligned(p1, 1e-5))
        self.assertTrue(placo.Segment(p0, p1).is_point_aligned(p2, 1e-5))
        self.assertFalse(placo.Segment(p0, p1).is_point_aligned(p3, 1e-5))

    def test_segment_aligned(self):
        p0 = np.array([0, 0])
        p1 = np.array([1, 1])
        p2 = np.array([2, 2])
        p3 = np.array([3, 3])
        p4 = np.array([1, 0])
        p5 = np.array([2, 1])
        self.assertTrue(placo.Segment(p0, p1).is_segment_aligned(placo.Segment(p2, p3), 1e-5))
        self.assertFalse(placo.Segment(p0, p1).is_segment_aligned(placo.Segment(p4, p5), 1e-5))
    ...
    def test_point_in_segment(self):
        ...
        p3 = np.array([0.5, 0.5])
        p4 = np.array([1.5, 1.5])
        self.assertTrue(placo.Segment(p0, p1).is_point_in_segment(p0, 1e-5))
        self.assertTrue(placo.Segment(p0, p1).is_point_in_segment(p1, 1e-5))
        self.assertFalse(placo.Segment(p0, p1).is_point_in_segment(p2, 1e-5))
        self.assertTrue(placo.Segment(p0, p1).is_point_in_segment(p3, 1e-5))
        self.assertFalse(placo.Segment(p0, p1).is_point_in_segment(p4, 1e-5))
