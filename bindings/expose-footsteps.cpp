...
void exposeFootsteps() {
  ...
  class__<FootstepsPlanner::Footstep>("Footstep", init<double, double>())
      .add_property("side", &FootstepsPlanner::Footstep::side,
                    &FootstepsPlanner::Footstep::side)
      .add_property("foot_length", &FootstepsPlanner::Footstep::foot_length,
                    &FootstepsPlanner::Footstep::foot_length)
      .add_property("foot_width", &FootstepsPlanner::Footstep::foot_width,
                    &FootstepsPlanner::Footstep::foot_width)
      .add_property(
          "frame",
          +[](FootstepsPlanner::Footstep &footstep) { return footstep.frame; },
  ...
  class__<FootstepsPlanner::Support>("Support", init<>())
      ...
      .def(
          "set_start", +[](FootstepsPlanner::Support &support,
                           bool b) { support.start = b; })
      .def(
          "set_end",
          +[](FootstepsPlanner::Support &support, bool b) { support.end = b; })
      .add_property("footsteps", &FootstepsPlanner::Support::footsteps,
                    &FootstepsPlanner::Support::footsteps)
      .add_property("t_start", &FootstepsPlanner::Support::t_start,
                    &FootstepsPlanner::Support::t_start)
      .add_property("elapsed_ratio", &FootstepsPlanner::Support::elapsed_ratio,
                    &FootstepsPlanner::Support::elapsed_ratio)
      .add_property("time_ratio", &FootstepsPlanner::Support::time_ratio,
                    &FootstepsPlanner::Support::time_ratio)
      .add_property("start", &FootstepsPlanner::Support::start,
                    &FootstepsPlanner::Support::start)
      .add_property("end", &FootstepsPlanner::Support::end,
                    &FootstepsPlanner::Support::end)
      .add_property("target_world_dcm",
  ...
  class__<FootstepsPlanner, boost::noncopyable>("FootstepsPlanner", no_init)
      ...
      .def("clipped_opposite_footstep",
           &FootstepsPlanner::clipped_opposite_footstep)
      .def(
          "truncate_supports",
          +[](const std::vector<FootstepsPlanner::Support> &supports, int index,
              bool add_end) {
            ...
            if (add_end && !head.back().end) {
              ...
              if (end_support.footsteps.size() == 1) {
                if (HumanoidRobot::other_side(
                        supports[index].footsteps[0].side) ==
                    end_support.footsteps[0].side) {
  ...
  class__<FootstepsPlannerNaive, bases<FootstepsPlanner>>(
      "FootstepsPlannerNaive", init<HumanoidParameters &>())
      .def("plan", &FootstepsPlannerNaive::plan)
      .def("configure", &FootstepsPlannerNaive::configure);

  class__<FootstepsPlannerRepetitive, bases<FootstepsPlanner>>(
      "FootstepsPlannerRepetitive", init<HumanoidParameters &>())
